...
/*F**************************************************************************
* ÍÀÇÂÀÍÈÅ: hick_clockPll_system_clock_config
*----------------------------------------------------------------------------
* ÏÀÐÀÌÅÒÐÛ:
* f_pep - ÷àñòîòà ÏÝÏ â êÃö
* ÂÛÕÎÄ:
* 
*----------------------------------------------------------------------------
* ÍÀÇÍÀ×ÅÍÈÅ:
...
*----------------------------------------------------------------------------
* ÎÏÈÑÀÍÈÅ:
* Íàñòðîéêà òàêòèðîâàíèÿ, èñòî÷íèê ñèãíàëà PLL - RC ãåíåðàòîð
* íà âûõîäå PLL ÷àñòîòà ïðèáëèæåííàÿ ê (f_pep* 1ÌÃö)
*----------------------------------------------------------------------------
* ÒÐÅÁÎÂÀÍÈß:
****************************************************************************/
...
/*F**************************************************************************
* ÍÀÇÂÀÍÈÅ: hext_clock_Pll_system_clock_config
*----------------------------------------------------------------------------
* ÏÀÐÀÌÅÒÐÛ:
* f_pep - ÷àñòîòà ÏÝÏ â êÃö
* ÂÛÕÎÄ:
...
*----------------------------------------------------------------------------
* ÎÏÈÑÀÍÈÅ:
* Íàñòðîéêà òàêòèðîâàíèÿ, èñòî÷íèê ñèãíàëà PLL - âíåøíèé êâàðö
* íà âûõîäå PLL ÷àñòîòà ïðèáëèæåííàÿ ê (f_pep* 1ÌÃö)
*----------------------------------------------------------------------------
* ÒÐÅÁÎÂÀÍÈß:
****************************************************************************/
...
*----------------------------------------------------------------------------
* ÎÏÈÑÀÍÈÅ:
* Íàñòðîéêà ÷àñòîòû òàêòèðîâàíèÿ ÀÖÏ, â çàâèñèìîñòè îò ÷àñòîòû PLL
*----------------------------------------------------------------------------
* ÒÐÅÁÎÂÀÍÈß:
****************************************************************************/
